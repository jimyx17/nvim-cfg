...
local function buf_try_add(server_name, bufnr)
  Log:debug("calling with: " .. server_name)
...
local function client_is_configured(server_name, ft)
  Log:debug("checking whether LSP client is configured for :" .. server_name)
...
local function launch_server(server_name, config)
  pcall(function()
    ...
    Log:debug("trying to boot up server: " .. server_name)
...
function M.setup(server_name, user_config)
  Log:debug("called LSP server bootup: " .. server_name)

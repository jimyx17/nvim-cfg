...
local ftplugin_dir = vim.lsp.templates_dir
...
local skipped_filetypes = vim.lsp.automatic_configuration.skipped_filetypes
local skipped_servers = vim.lsp.automatic_configuration.skipped_servers
local ensure_installed_servers = vim.lsp.installer.setup.ensure_installed
